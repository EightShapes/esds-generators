...
function (_LitElement) {
  _inherits(JediMaster, _LitElement);

  function JediMaster() {
    _classCallCheck(this, JediMaster);

    return _possibleConstructorReturn(this, _getPrototypeOf(JediMaster).apply(this, arguments));
  }

  _createClass(JediMaster, [{
    key: "render",
    value: function render() {
